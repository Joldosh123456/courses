...
function BlogPost() {
  ...
  const renderPostsCards = useMemo(() => {
    ...
    return filtered.map((elem, index) => index >= (page - 1) * pageElems && index < pageElems * page ? (
  ...
  return (
    <article className={`container ${css['BlogPost']} ${ darkScheme ? css['BlogPost-dark'] : ""} flex gap-2 py-32`}>
      <div className={`${css['BlogPost_fix']} flex flex-col items-center  gap-16`}>
      ...
      <div className={`${css['BlogPost_sideBar']} flex flex-col gap-10 `}>
        ...
        <div className={`${css['BlogPost_sideBar-Categories']} flex flex-col gap-6`}>
          <h1>Categories</h1>
          {
        ...
        <div className={`${css['BlogPost_sideBar-recentPosts']} flex flex-col gap-8`}>
            <h1>Recent Posts</h1>
          {
            RecentsPostsData.map(elem => (
              <div className={`${css['BlogPost_sideBar-recentPosts_card']} flex items-center gap-4`}>
        ...
        <div className={`${css['BlogPost_sideBar-PopularTags']} flex flex-col gap-8`}>
            <h1>Popular Tags</h1>
          <div  className={`${css['BlogPost_sideBar-PopularTags_Tags']} flex flex-wrap gap-2`}>
            {
              PopularTagsData.map(elem => (
                <div className={`${css['BlogPost_sideBar-PopularTags_card']} py-1 px-3 h-9 rounded-lg`}>
                  <h1>{elem.title}</h1>
                </div>
              ))
            }
        ...
        <div className={`${css['BlogPost_sideBar-Advertisement']} flex flex-col items-center pt-36 px-10 pb-10`}> 
          <h1>Advertisement</h1>
