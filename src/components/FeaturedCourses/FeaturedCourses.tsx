...
function FeaturedCourses() {
  ...
  return (
    <article
      className={`${css["FeaturedCourses"]} ${
        darkScheme ? css["FeaturedCourses-dark"] : ""
      } pt-16 sm:pt-20 pb-16 sm:pb-28`}
    >
      <div
        className={`container flex flex-col gap-2 sm:gap-10 relative sm:static`}
      >
        <div
        ...
        >
          ...
          <div
            className={`${css["FeaturedCourses__swiper-buttons"]} flex gap-1 h-fit [&>button]:p-2 [&>button]:rounded-full [&>button]:absolute [&>button]:sm:static`}
          >
            <button ref={prevBtn}>
